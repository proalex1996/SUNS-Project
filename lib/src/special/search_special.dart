...
class SearchSpecialScreen extends StatefulWidget {
  final String type;
  final String provinceId;
  final int departmentId;
  SearchSpecialScreen({this.provinceId, this.type, this.departmentId});

  @override
  _SearchSpecialScreenState createState() => _SearchSpecialScreenState();
}

class _SearchSpecialScreenState extends State<SearchSpecialScreen> {
          ...
          IconButton(
            ...
            onPressed: () {
              if (_searchController.text.length >= 2) {
                bloc.dispatch(EventSearchDepartment(
