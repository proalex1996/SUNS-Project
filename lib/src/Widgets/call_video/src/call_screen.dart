...
import 'package:suns_med/src/Widgets/call_video/src/signaling.dart';
...
class _CallingState extends State<Calling> {
  ...
  void _connect() async {
    if (_signaling == null) {
      _signaling = Signaling(widget.ip)..connect();
              ...
              child: Column(
                children: <Widget>[
                  ...
                  FlatButton(
                    ...
                    color: Colors.green,
                    onPressed: () {
                      _invitePeer(context, _textEditingController.text, false);
                    },
                  )
                ],
              ),
